...
env.Append(LIBS=["godot-cpp" + "." + platform + ".debug." + str(bits)])

sources = []
add_sources(sources, "src")

library = env.SharedLibrary(target=final_lib_path + 'libinterpolation', source=sources)
Default(library)
